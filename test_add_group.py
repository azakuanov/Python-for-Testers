...
class test_python(unittest.TestCase):
    ...
    def test_test_python(self):
        ...
        wd.find_element_by_name("group_name").send_keys("RandomName")
        ...
        wd.find_element_by_name("group_header").send_keys("RandomHeader")
        wd.find_element_by_name("group_footer").click()
        wd.find_element_by_name("group_footer").clear()
        wd.find_element_by_name("group_footer").send_keys("RandomFooter")
